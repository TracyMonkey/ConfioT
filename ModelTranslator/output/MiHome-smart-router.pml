...
/******************** Configurations *************************/
inline Mihome_smart_router_SHARE(userA,userB)
{
    atomic{
        check_policy_result = false;
            res_need_check.id = 1;
        ...
        if
            ::  (check_policy_result == true) ->
                printf("user_%d perform Mihome_smart_router_SHARE \n", userA);
                // Create Policies
...
inline Mihome_smart_router_REVOKE(userA,userB)
{
    atomic{
        check_policy_result = false;
            res_need_check.id = 1;
        ...
        if
            ::  (check_policy_result == true) ->
                printf("user_%d perform Mihome_smart_router_REVOKE \n", userA);
...
proctype ProcessHost(){
    ...
    bool COMPETE_host_4 = false;
        bool COMPETE_host_Mihome_smart_router_SHARE = false;
    
        bool COMPETE_host_Mihome_smart_router_REVOKE = false;
    ...
    do
        ...
        ::
            atomic{
                if
                    :: (COMPETE_host_Mihome_smart_router_SHARE == false) ->
                        COMPETE_host_Mihome_smart_router_SHARE = true;
                        Mihome_smart_router_SHARE(host, guest);
        ...
        ::
            atomic{
                if
                    :: (COMPETE_host_Mihome_smart_router_REVOKE == false) ->
                        COMPETE_host_Mihome_smart_router_REVOKE = true;
                        Mihome_smart_router_REVOKE(host, guest);
...
proctype ProcessGuest(){
    ...
    bool COMPETE_guest_4 = false;
        bool COMPETE_guest_Mihome_smart_router_SHARE = false;
    
        bool COMPETE_guest_Mihome_smart_router_REVOKE = false;
...
init
{
    atomic{
        ...
        /******************** Device *************************/
            Device.id = 0;
        Device.resources[0].id = 5;
            Device.resources[1].id = 4;
