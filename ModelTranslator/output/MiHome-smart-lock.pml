...
/******************** Configurations *************************/
inline Mihome_smart_lock_SHARE(userA,userB)
{
    atomic{
        check_policy_result = false;
            res_need_check.id = 1;
        ...
        if
            ::  (check_policy_result == true) ->
                printf("user_%d perform Mihome_smart_lock_SHARE \n", userA);
...
proctype ProcessHost(){
    ...
    bool COMPETE_host_4 = false;
        bool COMPETE_host_Mihome_smart_lock_SHARE = false;
    ...
    do
        ...
        ::
            atomic{
                if
                    :: (COMPETE_host_Mihome_smart_lock_SHARE == false) ->
                        COMPETE_host_Mihome_smart_lock_SHARE = true;
                        Mihome_smart_lock_SHARE(host, guest);
...
proctype ProcessGuest(){
    ...
    bool COMPETE_guest_4 = false;
        bool COMPETE_guest_Mihome_smart_lock_SHARE = false;
